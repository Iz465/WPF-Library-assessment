...
namespace WPF_Library_assessment.Mongo_Info
{
    ...
    Books() { }
        Books(string name, string author, int pages, string imageSource, string available, string overdue, int time, string owner, string preBookOwner, string imagesSource) {
            Name = name;
            Author = author;
            Pages = pages;
            Author = author;
